 ...
 * Uses UUID for model_id to match auth.users UUID primary key.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotPermission, $modelMorphKey) {
            $table->unsignedBigInteger($pivotPermission);
            $table->string('model_type');
            $table->uuid($modelMorphKey);                               // UUID instead of unsignedBigInteger
        ...
        Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $pivotRole, $modelMorphKey) {
