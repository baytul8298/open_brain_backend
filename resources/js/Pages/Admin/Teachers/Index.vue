...
const verificationQueue = [
  { name: 'Dr. Nusrat Jahan', email: 'nusrat@example.com', subject: 'Chemistry', submitted: '2 hrs ago', color: '#6b4aaf' },
  { name: 'Md. Touhid Islam', email: 'touhid@example.com', subject: 'Physics', submitted: '5 hrs ago', color: '#2c5f9e' },
  { name: 'Fatema Begum', email: 'fatema@example.com', subject: 'Biology', submitted: '1 day ago', color: '#c9893c' },
]

const teachers = [
  { name: 'Dr. Rahim Uddin', email: 'rahim@example.com', subject: 'Physics', courses: 8, students: 3240, revenue: '৳38,400', rating: '4.9', status: 'Active', color: '#2d8a5e' },
  { name: 'Ms. Shahnaz Khanam', email: 'shahnaz@example.com', subject: 'Mathematics', courses: 6, students: 2810, revenue: '৳31,200', rating: '4.8', status: 'Active', color: '#c9893c' },
  { name: 'Mr. Kamal Hasan', email: 'kamal@example.com', subject: 'English', courses: 5, students: 1920, revenue: '৳19,200', rating: '4.7', status: 'Active', color: '#2c5f9e' },
  { name: 'Dr. Sadia Islam', email: 'sadia@example.com', subject: 'Chemistry', courses: 4, students: 1540, revenue: '৳16,800', rating: '4.6', status: 'Active', color: '#6b4aaf' },
  { name: 'Ms. Roksana Parvin', email: 'roksana@example.com', subject: 'Biology', courses: 3, students: 980, revenue: '৳10,200', rating: '4.5', status: 'Active', color: '#b84b2f' },
  { name: 'Mr. Jahangir Kabir', email: 'jahangir@example.com', subject: 'ICT', courses: 2, students: 420, revenue: '৳4,200', rating: '4.2', status: 'Suspended', color: '#8a7f72' },
]
</script>
  ...
  <AppLayout>
    ...
    <div style="background:#100d09;position:relative;overflow:hidden;padding:28px 26px 26px;flex-shrink:0;">
      ...
      <div style="position:relative;z-index:1;display:flex;align-items:flex-start;justify-content:space-between;gap:18px;flex-wrap:wrap;">
        <div>
          <div class="hero-ey">Educator Management</div>
          <h1 class="hero-h">Teacher <em>Directory</em></h1>
          <p class="hero-p">Manage verified educators, review applications, and monitor teaching performance.</p>
        </div>
        <div class="kpis">
          <div class="kpi">
            <div class="kpi-v">284</div>
            <div class="kpi-l">Total</div>
            <div class="kpi-d ku">+12</div>
          </div>
          <div class="kpi">
            <div class="kpi-v">261</div>
            <div class="kpi-l">Active</div>
            <div class="kpi-d ku">+8</div>
          </div>
          <div class="kpi">
            <div class="kpi-v">3</div>
            <div class="kpi-l">Pending</div>
            <div class="kpi-d kw">review</div>
          </div>
          <div class="kpi">
            <div class="kpi-v">4.7★</div>
    ...
    <div class="pb">
      ...
      <div class="card">
        <div class="ch">
          <span class="ct">Verification <em>Queue</em></span>
          <span class="badge bg-o">3 Pending</span>
        </div>
        <div class="cb" style="padding:0;">
          <div class="tw">
            <table class="dt">
              ...
              <tbody>
                <tr v-for="t in verificationQueue" :key="t.email">
                  <td>
                    <div class="uc">
                      <div class="uav" :style="{ background: t.color }">{{ t.name.charAt(0) }}</div>
                      <div>
                        <div class="unm">{{ t.name }}</div>
                        <div class="uem">{{ t.email }}</div>
                      </div>
                    </div>
                  </td>
                  <td><span class="badge bg-b">{{ t.subject }}</span></td>
                  <td style="color:#8a7f72;">{{ t.submitted }}</td>
                  <td>
      ...
      <div class="card">
        <div class="ch">
          <span class="ct">All <em>Teachers</em></span>
          <div class="tb">
            <div class="ts">
        ...
        <div class="cb" style="padding:0;">
          <div class="tw">
            <table class="dt">
              ...
              <tbody>
                <tr v-for="t in teachers" :key="t.email">
                  <td>
                    <div class="uc">
                      <div class="uav" :style="{ background: t.color }">{{ t.name.charAt(0) }}</div>
                      <div>
                  ...
                  <td><span style="font-family:'Playfair Display',serif;">{{ t.revenue }}</span></td>
                  <td><span style="color:#c9893c;font-weight:700;">{{ t.rating }}★</span></td>
                  <td><span class="badge" :class="t.status === 'Active' ? 'bg-g' : 'bg-r'">{{ t.status }}</span></td>
                  <td>
                    <div class="ar">
                      <button class="btn bg2 bxs">View</button>
                      <button class="btn bd bxs">Suspend</button>
                    </div>
                  </td>
                </tr>
              </tbody>
